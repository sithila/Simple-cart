...
$myurlvariable = $postData->ID;	
	$conn = new mysqli("localhost", "root", "", "simple-cart");

$result = $conn->query("SELECT id, product_name, product_desc, product_price, product_code, product_image  FROM products_list WHERE category = '" . $myurlvariable . "'");
